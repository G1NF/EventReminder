...
public class ReminderDatabase extends SQLiteOpenHelper {
    ...
    public int addReminder(Reminder reminder){
        ...
        values.put(KEY_EVENT_ID , reminder.getmEventId());
    ...
    public List<Reminder> getAllReminders(int event_id){
        List<Reminder> reminderList = new ArrayList<>();

        // Select all Query
        String selectQuery = "SELECT * FROM " + TABLE_REMINDERS + " WHERE event_id =" +event_id;
    ...
    public int updateReminder(Reminder reminder){
        ...
        values.put(KEY_REPEAT_TYPE, reminder.getRepeatType());
        values.put(KEY_ACTIVE, reminder.getActive());
        values.put(KEY_EVENT_ID, reminder.getActive());
