...
import com.ciwan.events.AlarmReceiver;
import com.ciwan.events.DateTimeSorter;
import com.ciwan.events.databases.ReminderDatabase;
import com.ciwan.events.models.Reminder;
...
public class ReminderListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventId = i.getIntExtra("EVENT_ID", -20);
        ...
        List<Reminder> mTest = rb.getAllReminders(eventId);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public class VerticalItemHolder extends SwappingHolder implements View.OnClickListener, View.OnLongClickListener {
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = ReminderListActivity.this;
        ...
        public List<ReminderItem> generateData(int count) {
            ...
            List<Reminder> reminders = rb.getAllReminders(eventId);
